...
export class LaunchScreenAppComponent implements OnInit, OnDestroy {
  ...
  menu = [
    { label: 'Generic Launch Screen Images', link: '/launch-screen/generic-launch-screen-image' },
    { label: 'Education Specific Launch Screen Images', link: '/launch-screen/education-specific-launch-screen-images' },
  ];
